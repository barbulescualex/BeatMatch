...
![title](logo.png)
 ...
 All the sounds were created by me, both the instruments and my voice (obviously 😉) using GarageBand and a coworker's Blue Yetti microphone. All image assets were created by me using Photoshop. The gif below was made using ezgif.com.
